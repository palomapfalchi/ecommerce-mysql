-- em cliente, adicionar rg antes do cpf
alter table cliente add column
	rg varchar(10) not null after senha;
    
-- alterar varchar do rg 
ALTER TABLE cliente
	modify rg varchar(15);
...
INSERT INTO produto VALUES (ecommerce2null, "Conector USB","Conector USB para recarga em tomada 3A",35,15,"conector.jpg",2);
...
-- adicionar auto increment no num_squencial.
ALTER TABLE item_pedido MODIFY num_sequencial INT NOT NULL auto_increment; 
